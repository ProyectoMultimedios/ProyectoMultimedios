...
<head>
	<meta charset="utf-8" />
	<title>Modificar Estudiante - Formoid jquery form validation</title>
...
<div class="submit"><input type="submit" value="Buscar"/></div></form><p class="frmd"><a href="http://formoid.com/v29.php">jquery form validation</a> Formoid.com 2.9</p><script type="text/javascript" src="modificar_files/formoid1/formoid-solid-blue.js"></script>
<!-- Stop Formoid form-->
